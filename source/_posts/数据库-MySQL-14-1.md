...
![1zCRFx.png](https://s2.ax1x.com/2020/02/15/1zCRFx.png)
...
![1zCH0A.png](https://s2.ax1x.com/2020/02/15/1zCH0A.png)
...
![QiWqtH.png](https://s2.ax1x.com/2019/11/28/QiWqtH.png)
...
![QifSnf.png](https://s2.ax1x.com/2019/11/28/QifSnf.png)
...
![QFAXPU.png](https://s2.ax1x.com/2019/11/28/QFAXPU.png)
...
![QFEPVx.png](https://s2.ax1x.com/2019/11/28/QFEPVx.png)
...
+------------------------------------+----------+
$  ls  /var/lib/mysql/ib*
/var/lib/mysql/ib_buffer_pool  /var/lib/mysql/ib_logfile0  /var/lib/mysql/ibtmp1
/var/lib/mysql/ibdata1         /var/lib/mysql/ib_logfile1
...
![QFVET0.png](https://s2.ax1x.com/2019/11/28/QFVET0.png)
...
![QFVBnA.png](https://s2.ax1x.com/2019/11/28/QFVBnA.png)
...
LOG
---
Log sequence number          63071590
Log buffer assigned up to    63071590
Log buffer completed up to   63071590
Log written up to            63071590
Log flushed up to            63071590
Added dirty pages up to      63071590
Pages flushed up to          63071590
Last checkpoint at           63071590
196227 log i/o's done, 0.00 log i/o's/second
----------------------
```
...
![QFZC4K.png](https://s2.ax1x.com/2019/11/28/QFZC4K.png)
...
undo log有两个作用：用于事务的回滚和多个行版本控制(MVCC)。
...
默认rollback segment全部写在一个文件中，但可以通过设置变量 innodb_undo_tablespaces 平均分配到多少个文件中。该变量默认值为0，即全部写入一个表空间文件。该变量为静态变量，只能在数据库示例停止状态下修改，如写入配置文件或启动时带上对应参数。
...
![QFeiaq.png](https://s2.ax1x.com/2019/11/28/QFeiaq.png)
...
2. [MySQL的undo,redo,二阶段提交思维导图](https://mp.weixin.qq.com/s/MDb0IVBUThM7XYpownclQw)