...
[RESTful](http://zh.wikipedia.org/wiki/REST) 是目前最流行的 API 设计规范，用于 Web 数据接口的设计。
...
客户端发送PUT，DELETE请求：可以采用Ajax方式发送PUT和DELETE请求
...
1. [你真的了解RESTful API吗？](https://zhuanlan.zhihu.com/p/91240556)