...
XSS 攻击全称跨站脚本攻击（Cross-Site Scripting），简单的说就是**攻击者通过在目标网站上注入恶意脚本并运行，获取用户的敏感信息如 Cookie、SessionID 等，影响网站与用户数据安全**。
...
2. [前端防御 XSS](https://juejin.im/entry/56da82a87664bf0052ebad41)
3. [浅说 XSS 和 CSRF](https://juejin.im/entry/5b4b56fd5188251b1a7b2ac1)
4. [XSS攻防实例](https://www.jianshu.com/p/6e58db0ac308)
5. [谷歌XSS小游戏通关手记（完结）](https://blog.csdn.net/abc_12366/article/details/82054946)